...
namespace LidarSickNS
{
    ...
    public class TIM561 : LidarDevice
    {
        #region Constructor & Properties
        public int robotId;

        /// <summary>Crée une instance de <see cref="TIM561"/> et se connecte au numéro de série spécifié.</summary>
        public TIM561(int id, int serialNumber, double startAngle, double endAngle, bool isUpsideDown)
        {
            _serialNumber = serialNumber;
            robotId = id;
            IsUpsideDown = isUpsideDown;
            AngleMin = Toolbox.RadToDeg(startAngle);
            AngleMax = Toolbox.RadToDeg(endAngle);
        }
